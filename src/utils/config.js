...
export const isStaging = () =>
  /^staging-app\.deriv\.(com|me|be)$/i.test(window.location.hostname);
...
export const isTestLink = () =>
  /^((.*)\.binary\.sx)$/i.test(window.location.hostname);
...
export const getSocketUrl = () => {
  ...
  const loginid =
    localStorage.getItem("active_loginid") || active_loginid_from_url;
...
export const configureEndpoint = (app_id, server_url) => {
